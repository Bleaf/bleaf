...
class Topo1(Topo):
    ...
    def __init__(self, n=1, cpu=.1, bw=100, delay=None,
        ...
        # TODO
        hostConfig = {'cpu': cpu}
        ethernetLinkConfig = {'bw': 10, 'delay': '1ms', 'loss': 0, 'max_queue_size': max_queue_size }
        wifiLinkConfig = {'bw': 2, 'delay': '5ms', 'loss': 3, 'max_queue_size': max_queue_size }
        threegLinkConfig = {'bw': 2, 'delay': '75ms', 'loss': 2, 'max_queue_size': max_queue_size }
        ...
        # Wire receiver
        # TODO
        self.addLink(receiver, s1, port1=0, port2=downlink, **ethernetLinkConfig)
        self.addLink(receiver, s2, port1=1, port2=downlink, **wifiLinkConfig)
        self.addLink(receiver, s3, port1=2, port2=downlink, **threegLinkConfig)

        # Wire sender
        # TODO
        self.addLink(sender, s1, port1=0, port2=uplink, **ethernetLinkConfig)
        self.addLink(sender, s2, port1=1, port2=uplink, **ethernetLinkConfig)
        self.addLink(sender, s3, port1=2, port2=uplink, **ethernetLinkConfig)
